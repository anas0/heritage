<!-- Top Footer -->
		...
		<div class="inner-container container">
			<div class="widget col-xs-6 col-md-4">
				...
				<div class="widget-content">
					Text widget can be used for putting text, images and some other elements in the widget areas. As an example you can add your short description about your Resort and add your logo in this area. Also you can add some useful information like notification in this area.
				</div>
			</div>
			<div class="widget col-xs-6 col-md-4">
				<h4>Newsletter</h4>
	...
	<footer id="footer">
		...
		<div class="copy-right">
			&copy; 2016 Heritage. All Rights Reserved.
		</div>
	</footer>
	<!-- End of Footer -->
